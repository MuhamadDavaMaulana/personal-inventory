    ...
    <div style={{ minHeight: '100vh', background: '#F0F4FF', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '32px 24px' }}>
        ...
        <div style={{
          ...
          {/* Condition */}
          <select style={{ ...s.filterInput, flex: '0 0 130px' }}
              ...
              {loading ? (
                ...
                filtered.map((item, i) => (
                  <tr key={item.item_id} className="item-row" style={{
                    ...
                    <td style={{ padding: '13px 16px', textAlign: 'center', fontWeight: 700, color: '#374151' }}>
                      {item.quantity}
                    </td>
                      ...
                      <div style={{ display: 'flex', gap: 6, justifyContent: 'center' }}>
                        ...
                        {item.status === 'available' && (
                          <ActionBtn
                            ...
                            onClick={() => {/* navigasi ke /loans/new?item_id=item.item_id */}}
                          />
                        )}
                        <ActionBtn
                          label="Hapus"
