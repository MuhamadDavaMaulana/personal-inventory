      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <h2 style={{
            ...
            Kelola Inventaris<br />Dengan Mudah &<br />Efisien
          </h2>
          <p style={{ color: 'rgba(255,255,255,0.65)', fontSize: '15px', lineHeight: 1.7, margin: 0 }}>
            Pantau semua aset dan barang milik Anda dalam satu platform yang terintegrasi.
          </p>
          ...
          <div style={{ display: 'flex', gap: '24px', marginTop: '40px' }}>
            {[
              ...
              { num: '99%', label: 'Uptime layanan' },
              { num: '4.9★', label: 'Rating pengguna' },
            ].map((s, i) => (
              <div key={i}>
                <div style={{ color: 'white', fontWeight: '800', fontSize: '22px' }}>{s.num}</div>
      ...
      <div style={{
        ...
        <div style={{ width: '100%' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '40px' }}>
            ...
            <span style={{ fontWeight: '800', fontSize: '16px', color: '#1E3A8A', letterSpacing: '0.01em' }}>
              Personal Inventory
            </span>
          </div>
          ...
          <p style={{ color: '#64748B', fontSize: '15px', margin: '0 0 32px' }}>
          ...
          <form onSubmit={handleSubmit}>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input
                  ...
                  style={{
                    ...
                    background: 'white',
                    border: '1.5px solid #E2E8F0',
                    borderRadius: '12px', padding: '13px 44px 13px 44px',
                    color: '#0F172A', fontSize: '14.5px',
                    outline: 'none', transition: 'all 0.18s',
                    boxShadow: '0 1px 3px rgba(0,0,0,0.04)',
                  }}
            ...
            <div style={{ textAlign: 'right', marginBottom: '24px' }}>
              <a href="#" style={{ fontSize: '13px', color: '#2563EB', fontWeight: '600', textDecoration: 'none' }}
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '14px', margin: '28px 0' }}>
            ...
            <span style={{ fontSize: '13px', color: '#94A3B8', fontWeight: '500' }}>belum punya akun?</span>
            <div style={{ flex: 1, height: '1px', background: '#E2E8F0' }} />
          </div>
          ...
          {/* Footer note */}
          <p style={{ textAlign: 'center', fontSize: '12px', color: '#94A3B8', margin: '24px 0 0' }}>
